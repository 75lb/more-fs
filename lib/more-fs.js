...
exports.moveFile = function(options, done){
...
exports.preserveDates = function(from, to){
...
exports.expandFileList = function(filePaths, include, exclude){
    var output = [],
        self = this;
...
exports.getTempFilePath = function(file){
